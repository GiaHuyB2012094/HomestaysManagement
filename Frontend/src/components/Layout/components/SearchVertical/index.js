...
function SearchVertical( props ) {
    ...
    useEffect(()=>{
            const data =  {price, search, selected, fromdate, todate, quanlityBedSingle, quanlityBedCouple}
            props.sendDataSearch(data);
    },[props,price, search, selected, fromdate, todate, quanlityBedSingle, quanlityBedCouple])
